...
/**
 * Fragment containing times for sunday
 */
public class SundayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        /* Check if route is available on weekends */
        String filename;
    ...
    /* Thread to update current time and nextbus time */
    public void doWork() {
    ...
    /* Stop and start the thread as needed */
    @Override
